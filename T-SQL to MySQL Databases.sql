---------------------------------------------------------------------
-- The codes bellow are reverse engineered from the book 
-- "Querying Microsoft SQL Server 2012 - Training Kit" by Itzik Ben-Gan, Dejan Sarka, Ton Talmage
-- Parts of the codes' structure have been maintained as the original
-- since MySQL sintax varies little from T-SQL (Microsoft SQL Server 2012) sintax.

-- All the rights of the databases and code snipets goes to the authors and publishers of the book
-- "Querying Microsoft SQL Server 2012 - Training Kit" by Itzik Ben-Gan, Dejan Sarka, Ton Talmage
---------------------------------------------------------------------
